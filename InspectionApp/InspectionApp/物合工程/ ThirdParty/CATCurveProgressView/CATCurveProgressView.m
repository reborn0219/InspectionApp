...
-(void)_commonInit{
    ...
    _trackLayer.strokeColor = HexRGB(0xE8E8E8).CGColor;
...
-(void)setProgressLineWidth:(CGFloat)progressLineWidth{
    ...
    UIBezierPath *path=[UIBezierPath bezierPathWithArcCenter:CGPointMake(self.frame.size.width/2, self.frame.size.height/2) radius:radius startAngle:CATDegreesToRadians(_startAngle) endAngle:CATDegreesToRadians(_endAngle) clockwise:NO];

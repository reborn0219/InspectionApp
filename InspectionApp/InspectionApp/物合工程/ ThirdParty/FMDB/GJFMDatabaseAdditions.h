...
/** Category of additions for `<GJFMDatabase>` class.
...
@interface GJFMDatabase (GJFMDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `GJFMResultSet` of schema; `nil` on error.

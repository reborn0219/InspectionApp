...
-(id)initWithFrame:(CGRect)frame
{
    ...
    if(self){
        ...
        workNmaelable = [[UILabel alloc]initWithFrame:CGRectMake(5, 0,imageView.size.width, 30)];
        workNmaelable.text = @"选择维修人员";
        workNmaelable.textColor = gycoloer;
        workNmaelable.backgroundColor = [UIColor clearColor];
        workNmaelable.font = [UIFont fontWithName:geshi size:13];

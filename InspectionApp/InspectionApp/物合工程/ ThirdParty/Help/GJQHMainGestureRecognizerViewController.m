...
@interface GJQHMainGestureRecognizerViewController ()<UIGestureRecognizerDelegate>
{
    CGPoint _startTouch;
...
@implementation GJQHMainGestureRecognizerViewController

static GJQHMainGestureRecognizerViewController *mainGRViewCtrl;
...
{
    CGFloat aa = fabs(startBackViewX)/[UIScreen mainScreen].bounds.size.width;
    CGFloat y = x*aa;

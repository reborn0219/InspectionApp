...
@class GJMHPhotosBrowserView;
@protocol MHPhotosBrowseDelegate <NSObject>
@optional
- (void)photosBrowse:(GJMHPhotosBrowserView *)photosBrowse didSelectItemAtIndex:(NSInteger)index;
- (void)photosBrowse:(GJMHPhotosBrowserView *)photosBrowse didClickDeleteBtnAtIndex:(NSInteger)index;
@end

@interface GJMHPhotosBrowserView: UIView<UICollectionViewDataSource,UIScrollViewAccessibilityDelegate,UICollectionViewDelegateFlowLayout>
{
    CGRect frameRect;

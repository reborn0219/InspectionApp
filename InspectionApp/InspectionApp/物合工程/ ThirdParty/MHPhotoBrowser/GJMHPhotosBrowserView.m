...
@interface GJMHPhotosBrowserView()
@property (assign, nonatomic) int currentIndex;
@end

@implementation GJMHPhotosBrowserView
...
- (void)createView
{
    ...
    [photoCollectionView registerClass:[GJMHPhotoCollectionCell class] forCellWithReuseIdentifier:@"photoCollectionViewCellIndex"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    GJMHPhotoCollectionCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"photoCollectionViewCellIndex" forIndexPath:indexPath];
    
    GJMHPhotoModel *photo = nil;
    photo = [photoArray objectAtIndex:itemIndex];
    [cell reloadCellWith:photo];
    
    if (itemIndex < (int)photoArray.count-1) {
        GJMHPhotoCollectionCell *nextCell = [[GJMHPhotoCollectionCell alloc] init];

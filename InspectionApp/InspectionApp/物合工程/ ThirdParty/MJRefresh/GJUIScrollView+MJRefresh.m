...
#import "GJUIScrollView+MJRefresh.h"
#import "GJMJRefreshHeader.h"
#import "GJMJRefreshFooter.h"
...
- (void)setMj_header:(GJMJRefreshHeader *)mj_header
{
...
- (void)setMj_footer:(GJMJRefreshFooter *)mj_footer
{
...
- (GJMJRefreshFooter *)mj_footer
{
    return objc_getAssociatedObject(self, &MJRefreshFooterKey);
}

#pragma mark - 过期
- (void)setFooter:(GJMJRefreshFooter *)footer
{
    self.mj_footer = footer;
}

- (GJMJRefreshFooter *)footer
{
    return self.mj_footer;
}

- (void)setHeader:(GJMJRefreshHeader *)header
{
    self.mj_header = header;
}

- (GJMJRefreshHeader *)header
{

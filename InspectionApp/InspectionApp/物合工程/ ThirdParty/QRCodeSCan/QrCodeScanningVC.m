...
- (void)viewDidLoad
{
    ...
    UILabel * labIntroudction= [[UILabel alloc] initWithFrame:CGRectMake(15,NavBar_H, SCREEN_WIDTH-30, 50)];
...
//    [self.view addSubview:labIntroudction];
    ...
    imgY=CGRectGetMaxY(labIntroudction.frame)+20+NavBar_H;

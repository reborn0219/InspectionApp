...
#import "GJNSTimer+Addition.h"

@interface GJSDAdScrollView ()<UIScrollViewDelegate>
...
@implementation GJSDAdScrollView
...
-(instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        [_currentImageView addGestureRecognizer:singleTap];
...
-(void)formatImageView:(UIImageView*)imageView imageData:(id)data
{
    if ([data isKindOfClass:[UIImage class]]) {
        ...
        if ([imageName hasPrefix:@"http"]) {
            //网络图片
            [imageView sd_setImageWithURL:[NSURL URLWithString:imageName]placeholderImage:[UIImage imageNamed:@"100x100"]];
        }else{
            //本地图片
...
-(UIPageControl*)pageControl
{
    if (!_pageControl) {
        ...
        _pageControl.currentPageIndicatorTintColor = NAVCOlOUR;

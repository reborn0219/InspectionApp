...
@interface GJSTKQueueEntry : NSObject
{
@public
    OSSpinLock spinLock;
...
@property (readwrite, retain) GJSTKDataSource* dataSource;

-(id) initWithDataSource:(GJSTKDataSource*)dataSource andQueueItemId:(NSObject*)queueItemId;

...
@interface GJCuiPickerView()<UIPickerViewDataSource, UIPickerViewDelegate>
{
    NSInteger yearRange;
    NSInteger dayRange;
    NSInteger startYear;
...
@implementation GJCuiPickerView
...
- (void)pickerView:(UIPickerView *)pickerView
    ...
    _string =[NSString stringWithFormat:@"%ld-%.2ld-%.2ld %.2ld:%.2ld",(long)selectedYear,(long)selectedMonth,selectedDay,selectedHour,selectedMinute];

...
@class GJKSDatePicker;
typedef NS_ENUM(NSUInteger, KSDatePickerButtonType) {
    KSDatePickerButtonCancel = 9999,
    KSDatePickerButtonCommit,
};

typedef void (^KSDatePickerResult)(GJKSDatePicker *datePicker,NSDate* currentDate,KSDatePickerButtonType buttonType);


@interface GJKSDatePickerAppearance : NSObject

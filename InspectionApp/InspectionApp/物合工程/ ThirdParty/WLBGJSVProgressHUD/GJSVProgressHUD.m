//
//  GJSVProgressHUD.h
//  GJSVProgressHUD, https://github.com/TransitApp/GJSVProgressHUD
//
//  Copyright (c) 2011-2014 Sam Vermette and contributors. All rights reserved.
//

#if !__has_feature(objc_arc)
#error GJSVProgressHUD is ARC only. Either turn on ARC for the project or use -fobjc-arc flag
#endif

#import "GJSVProgressHUD.h"
#import "GJSVIndefiniteAnimatedView.h"
#import "GJSVRadialGradientLayer.h"
...
- (GJSVIndefiniteAnimatedView *)createIndefiniteAnimatedView;
...
@implementation GJSVProgressHUD {
    BOOL _isInitializing;
}

+ (GJSVProgressHUD*)sharedView{
    static dispatch_once_t once;
    
    static GJSVProgressHUD *sharedView;
...
#pragma clang diagnostic pop
	...
	if(string) {
        if(self.defaultAnimationType == SVProgressHUDAnimationTypeFlat) {
            GJSVIndefiniteAnimatedView *indefiniteAnimationView = (GJSVIndefiniteAnimatedView *)self.indefiniteAnimatedView;
...
- (void)updateMask{
    ...
    switch (self.defaultMaskType){
        ...
        case SVProgressHUDMaskTypeGradient:{
            GJSVRadialGradientLayer *layer = [GJSVRadialGradientLayer layer];
...
- (void)showProgress:(float)progress status:(NSString*)string{
    ...
    if(self.alpha != 1 || self.hudView.alpha != 1){
        ...
        __weak GJSVProgressHUD *weakSelf = self;
        [UIView animateWithDuration:0.15
                              delay:0
                            options:UIViewAnimationOptionAllowUserInteraction | UIViewAnimationCurveEaseOut | UIViewAnimationOptionBeginFromCurrentState
                         animations:^{
                             __strong GJSVProgressHUD *strongSelf = weakSelf;
                             if(strongSelf){
...
- (GJSVIndefiniteAnimatedView *)createIndefiniteAnimatedView{
    GJSVIndefiniteAnimatedView *indefiniteAnimatedView = [[GJSVIndefiniteAnimatedView alloc] initWithFrame:CGRectZero];

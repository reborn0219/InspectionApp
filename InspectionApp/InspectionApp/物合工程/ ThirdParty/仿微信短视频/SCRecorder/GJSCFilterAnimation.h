...
@interface GJSCFilterAnimation : NSObject<NSCoding>
...
+ (GJSCFilterAnimation *__nonnull)filterAnimationForParameterKey:(NSString *__nonnull)key startValue:(__nullable id)startValue endValue:(__nullable id)endValue startTime:(CFTimeInterval)startTime duration:(CFTimeInterval)duration;

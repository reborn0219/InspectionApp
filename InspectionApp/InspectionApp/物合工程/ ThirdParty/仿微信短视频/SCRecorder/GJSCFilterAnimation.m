...
@interface GJSCFilterAnimation() {
    
}

@end

@implementation GJSCFilterAnimation
...
+ (GJSCFilterAnimation *)filterAnimationForParameterKey:(NSString *)key startValue:(id)startValue endValue:(id)endValue startTime:(CFTimeInterval)startTime duration:(CFTimeInterval)duration {
    return [[GJSCFilterAnimation alloc] initWithKey:key startValue:startValue endValue:endValue startTime:startTime duration:duration];
}

 ...
 */
@interface GJSCImageView : UIView
...
/**
 The GJSCContext that hold the underlying CIContext for rendering the CIImage's
 ...
 */
@property (strong, nonatomic) GJSCContext *__nullable context;
...
/**
 ...
 when needed. This avoids creating multiple CIImage if the GJSCImageView can't render them
 as fast.
 */

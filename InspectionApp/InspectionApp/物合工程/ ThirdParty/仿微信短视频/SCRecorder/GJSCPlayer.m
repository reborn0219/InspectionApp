...
#import "GJSCPlayer.h"
#import "GJSCWeakSelectorTarget.h"

////////////////////////////////////////////////////////////
// PRIVATE DEFINITION
/////////////////////

@interface GJSCPlayer() <AVPlayerItemOutputPullDelegate, AVPlayerItemOutputPushDelegate> {
...
- (void)beginSendingPlayMessages {
    if (!self.isSendingPlayMessages) {
        __weak GJSCPlayer *myWeakSelf = self;
...
- (void)renderVideo:(CFTimeInterval)hostFrameTime {
    ...
    if ([_videoOutput hasNewPixelBufferForItemTime:outputItemTime]) {
        ...
        GJSCImageView *renderer = self.GJSCImageView;
...
- (void)setupDisplayLink {
    if (_displayLink == nil) {
        GJSCWeakSelectorTarget *target = [[GJSCWeakSelectorTarget alloc] initWithTarget:self targetSelector:@selector(willRenderFrame:)];
...
- (void)setSCImageView:(GJSCImageView *)GJSCImageView {
    _GJSCImageView = GJSCImageView;

    if (GJSCImageView == nil) {
        [self unsetupDisplayLink];
    } else {

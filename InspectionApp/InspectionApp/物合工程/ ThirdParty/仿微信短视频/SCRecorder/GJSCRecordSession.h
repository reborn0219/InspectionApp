...
#import "GJSCRecordSessionSegment.h"
...
@class GJSCRecordSession;
@class GJSCRecorder;

@interface GJSCRecordSession : NSObject
...
/**
 ...
 If null, the GJSCRecordSession will figure out one depending on the fileType.
 */
...
/**
 Contains every record segment as GJSCRecordSessionSegment.
 */
...
/**
 The recorder that is managing this GJSCRecordSession
 */
@property (readonly, nonatomic, weak) GJSCRecorder *__nullable recorder;
...
/**
 Create a GJSCRecordSession
 */
+ (nonnull instancetype)recordSession;

/**
 Create a GJSCRecordSession based on dictionary representation
 */
+ (nonnull instancetype)recordSession:(nonnull NSDictionary *)dictionaryRepresentation;

/**
 Calling any method of GJSCRecordSession is thread safe. However,
 if the record session is inside an GJSCRecorder instance, its state
 ...
 access to any modification on this GJSCRecordSession.
 */
 ...
 */
- (void)removeSegment:(GJSCRecordSessionSegment *__nonnull)segment;
 ...
 */
- (void)addSegment:(GJSCRecordSessionSegment *__nonnull)segment;

/**
 Insert a record segment.
 */
- (void)insertSegment:(GJSCRecordSessionSegment *__nonnull)segment atIndex:(NSInteger)segmentIndex;
...
/**
 ...
 you should remove the GJSCRecordSession from the GJSCRecorder
 */
...
/**
 Returns a dictionary that represents this GJSCRecordSession
...
/**
 ...
 This method is automatically called by the GJSCRecorder.
 */
...
/**
 ...
 This method is automatically called by the GJSCRecorder
 when calling [GJSCRecorder pause] if necessary.
 ...
 If you don't remove the GJSCRecordSession from the GJSCRecorder while calling this method,
 The GJSCRecorder might create a new recordSegment right after automatically if it is not paused.
 */
- (BOOL)endSegmentWithInfo:(NSDictionary *__nullable)info completionHandler:(void(^__nullable)(GJSCRecordSessionSegment *__nullable segment, NSError *__nullable error))completionHandler;

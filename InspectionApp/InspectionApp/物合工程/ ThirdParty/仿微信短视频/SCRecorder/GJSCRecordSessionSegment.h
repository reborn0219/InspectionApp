...
@interface GJSCRecordSessionSegment : NSObject
 ...
 */
+ (GJSCRecordSessionSegment *__nonnull)segmentWithURL:(NSURL *__nonnull)url info:(NSDictionary *__nullable)info;

...
@interface GJSCRecorder : NSObject<AVCaptureAudioDataOutputSampleBufferDelegate, AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureFileOutputRecordingDelegate>
 ...
 */
@property (readonly, nonatomic) GJSCPhotoConfiguration *__nonnull photoConfiguration;
...
/**
 Will be true if the GJSCRecorder is currently recording
 */
...
/**
 Set the delegate used to receive messages for the GJSCRecorder
 */
 ...
 */
@property (strong, nonatomic) GJSCRecordSession *__nullable session;
...
/**
 ...
 by GJSCVideoConfiguration and GJSCAudioConfiguration. It will internally 
...
/**
 The dispatch queue that the GJSCRecorder uses for sending messages to the attached
 GJSCRecordSession.
 */
 ...
 */
+ (GJSCRecorder *__nonnull)recorder;
 ...
 */
+ (GJSCRecorder *__nonnull)sharedRecorder;

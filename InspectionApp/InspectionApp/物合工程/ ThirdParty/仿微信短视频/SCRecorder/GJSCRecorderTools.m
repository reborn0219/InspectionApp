...
@implementation GJSCRecorderTools
...
+ (BOOL)formatInRange:(AVCaptureDeviceFormat*)format frameRate:(CMTimeScale)frameRate {
    ...
    return [GJSCRecorderTools formatInRange:format frameRate:frameRate dimensions:dimensions];
}
...
+ (NSString *)bestCaptureSessionPresetForDevicePosition:(AVCaptureDevicePosition)devicePosition withMaxSize:(CGSize)maxSize {
    return [GJSCRecorderTools bestCaptureSessionPresetForDevice:[GJSCRecorderTools videoDeviceForPosition:devicePosition] withMaxSize:maxSize];
}
...
+ (NSString *)bestCaptureSessionPresetForDevice:(AVCaptureDevice *)device withMaxSize:(CGSize)maxSize {
    ...
    return [GJSCRecorderTools captureSessionPresetForDimension:highestDeviceDimension];
}
...
+ (NSString *)bestCaptureSessionPresetCompatibleWithAllDevices {
    ...
    return [GJSCRecorderTools captureSessionPresetForDimension:highestCompatibleDimension];
}
...
@implementation NSDate (GJSCRecorderTools)

...
@interface GJSCRecorderToolsView : UIView

/**
 The instance of the GJSCRecorder to use.
 */
@property (strong, nonatomic) GJSCRecorder *__nullable recorder;
...
///**
// When the GJSCRecorderToolsView should show the focus animation

...
#import "GJSCRecorderToolsView.h"
#import "GJSCRecorderFocusTargetView.h"
...
@interface GJSCRecorderToolsView()
{
...
@property (strong, nonatomic) GJSCRecorderFocusTargetView *cameraFocusTargetView;

@end

@implementation GJSCRecorderToolsView
...
- (void)commonInit {
    ...
    self.cameraFocusTargetView = [[GJSCRecorderFocusTargetView alloc] init];
...
- (void)pinchToZoom:(UIPinchGestureRecognizer *)gestureRecognizer {
    GJSCRecorder *strongRecorder = self.recorder;
...
- (void)setRecorder:(GJSCRecorder *)recorder {
    GJSCRecorder *oldRecorder = _recorder;

...
#import "GJSCSwipeableFilterView.h"
#import "GJSCSampleBufferHolder.h"

@interface GJSCSwipeableFilterView() {
}

@end

@implementation GJSCSwipeableFilterView
...
- (void)scrollToFilter:(GJSCFilter *)filter animated:(BOOL)animated {
...
- (CIImage *)renderedCIImageInRect:(CGRect)rect {
    ...
    while (index <= upIndex) {
        ...
        GJSCFilter *filter = [filters objectAtIndex:currentIndex];
...
- (void)setSelectedFilter:(GJSCFilter *)selectedFilter {

...
@interface GJSCVideoConfiguration : GJSCMediaTypeConfiguration
...
/**
 The maximum framerate that this GJSCRecordSession should handle
...
/**
 If not nil, each appended frame will be processed by this GJSCFilter.
 While it seems convenient, this removes the possibility to change the
 filter after the segment has been added.
 Setting a new filter will cause the GJSCRecordSession to stop the
...
/**
 ...
 Only used in GJSCAssetExportSession.
 */
...
/**
 Specify a buffer size to use. By default the GJSCAssetExportSession tries

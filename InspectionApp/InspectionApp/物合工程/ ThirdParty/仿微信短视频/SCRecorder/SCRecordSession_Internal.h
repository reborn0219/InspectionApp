...
@interface GJSCRecordSession() {
    ...
    GJSCVideoConfiguration *_videoConfiguration;
    GJSCAudioConfiguration *_audioConfiguration;
...
@property (weak, nonatomic) GJSCRecorder *recorder;
...
- (void)appendRecordSegmentUrl:(NSURL *)url info:(NSDictionary *)info error:(NSError *)error completionHandler:(void(^)(GJSCRecordSessionSegment *segment, NSError* error))completionHandler;

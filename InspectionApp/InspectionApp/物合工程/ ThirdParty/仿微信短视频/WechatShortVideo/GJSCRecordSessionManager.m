...
@implementation GJSCRecordSessionManager
...
static GJSCRecordSessionManager *_sharedInstance;

+ (GJSCRecordSessionManager *)sharedInstance {
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedInstance = [GJSCRecordSessionManager new];
    });

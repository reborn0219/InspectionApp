...
@interface GJXSMediaPlayer ()<UIGestureRecognizerDelegate>
...
@implementation GJXSMediaPlayer
...
//        self.backgroundColor = [UIColor redColor];
        ...
        self.maskView = [[GJXSMediaPlayerMaskView alloc]initWithFrame:CGRectMake(0, 0, frame.size.width, frame.size.height)];

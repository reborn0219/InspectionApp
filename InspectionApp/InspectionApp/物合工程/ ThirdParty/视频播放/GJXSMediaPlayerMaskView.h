...
@protocol fullScreenBtnDidClickedDelegate <NSObject>

-(void)fullScreenBtnDidClicked;

@end

@interface GJXSMediaPlayerMaskView : UIView
...
@property(nonatomic,assign)id<fullScreenBtnDidClickedDelegate>fullscreenDelegate;

...
#import "GJZXVideoPlayerControlView.h"
...
@interface GJZXVideoPlayerControlView ()
...
@implementation GJZXVideoPlayerControlView
...
- (void)layoutSubviews
{
    ...
    self.topBar.frame = CGRectMake(CGRectGetMinX(self.bounds), CGRectGetMinY(self.bounds), CGRectGetWidth(self.bounds), NavBar_H);
    ...
    // 返回按钮
    self.backButton.frame = CGRectMake(CGRectGetMinX(self.topBar.bounds), CGRectGetHeight(self.topBar.bounds) - 40, 35, 35);
    // 锁定按钮
...
- (UIButton *)playButton
{
    if (!_playButton) {
        ...
        [_playButton setImage:[UIImage imageNamed:@"icon_n_09@2x"] forState:UIControlStateNormal];
...
- (UIButton *)pauseButton
{
    if (!_pauseButton) {
        ...
        [_pauseButton setImage:[UIImage imageNamed:@"icon_n_09@2x1"] forState:UIControlStateNormal];
...
- (UIButton *)fullScreenButton
{
    if (!_fullScreenButton) {
        ...
        [_fullScreenButton setImage:[UIImage imageNamed:@"kr-video-player-shrinkscreen"] forState:UIControlStateNormal];
...
- (UIButton *)shrinkScreenButton
{
    if (!_shrinkScreenButton) {
        ...
        [_shrinkScreenButton setImage:[UIImage imageNamed:@"kr-video-player-fullscreen"] forState:UIControlStateNormal];
...
- (GJZXVideoPlayerTimeIndicatorView *)timeIndicatorView
{
    if (!_timeIndicatorView) {
        _timeIndicatorView = [[GJZXVideoPlayerTimeIndicatorView alloc] initWithFrame:CGRectMake(0, 0, kVideoTimeIndicatorViewSide, kVideoTimeIndicatorViewSide)];
    }
    return _timeIndicatorView;
}

- (GJZXVideoPlayerBrightnessView *)brightnessIndicatorView
{
    if (!_brightnessIndicatorView) {
        _brightnessIndicatorView = [[GJZXVideoPlayerBrightnessView alloc] initWithFrame:CGRectMake(0, 0, kVideoBrightnessIndicatorViewSide, kVideoBrightnessIndicatorViewSide)];
    }
    return _brightnessIndicatorView;
}

- (GJZXVideoPlayerVolumeView *)volumeIndicatorView
{
    if (!_volumeIndicatorView) {
        _volumeIndicatorView = [[GJZXVideoPlayerVolumeView alloc] initWithFrame:CGRectMake(0, 0, kVideoVolumeIndicatorViewSide, kVideoVolumeIndicatorViewSide)];
    }
    return _volumeIndicatorView;
}

- (GJZXVideoPlayerBatteryView *)batteryView
{
    if (!_batteryView) {
        _batteryView = [[GJZXVideoPlayerBatteryView alloc] initWithFrame:CGRectMake(0, 0, kVideoBatteryViewWidth, kVideoBatteryViewHeight)];
    }
    return _batteryView;
}

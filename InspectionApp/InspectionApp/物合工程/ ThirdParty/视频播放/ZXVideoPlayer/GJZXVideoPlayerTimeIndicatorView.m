//
//  GJZXVideoPlayerTimeIndicatorView.m
//  ZXVideoPlayer
//
...
@interface GJZXVideoPlayerTimeIndicatorView ()
...
@implementation GJZXVideoPlayerTimeIndicatorView
...
- (void)setLabelText:(NSString *)labelText
{
    ...
    if (self.superview.accessibilityIdentifier) {
        GJZXVideoPlayerControlView *playerView = (GJZXVideoPlayerControlView *)self.superview;

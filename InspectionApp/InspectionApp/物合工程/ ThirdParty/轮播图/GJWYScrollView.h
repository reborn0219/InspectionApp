 ...
 *  其他属性都有默认值，可不设置
 */
@interface GJWYScrollView : UIView

/*
 这里没有提供修改占位图片的接口，如果需要修改，可直接到.m文件中
 搜索"GJWYScrollView"替换为你想要显示的图片名称，或者将原有的占位
 图片删除并修改你想要显示的图片名称为"GJWYScrollView"。
 不需要占位图片的请将[UIImage imageNamed:@"GJWYScrollView"]

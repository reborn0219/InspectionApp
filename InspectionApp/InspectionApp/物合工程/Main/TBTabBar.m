...
- (void)layoutSubviews {
    ...
    CGFloat w_2 = self.width/3.0;
    
    UIButton *publishBtn = [[UIButton alloc] init];
    [publishBtn setImage:[UIImage imageNamed:@"patrol_scan"] forState:UIControlStateNormal];
//    [publishBtn setTitle:@"发布" forState:UIControlStateNormal];
    ...
    publishBtn.size = CGSizeMake(w_2,70);
    publishBtn.centerX = self.width / 2;
    publishBtn.centerY = self.height / 2-10;

...
// 视频的长宽按比例
#define kzVideo_w_h (kScreenWidth/kScreenHeight)

// 视频默认 宽的分辨率  高 = kzVideoWidthPX / kzVideo_w_h
#define kzVideoWidthPX  kScreenWidth

//控制条高度 小屏幕时
#define kzControViewHeight  kScreenHeight
// 是否保存到手机相册
...
@interface GJKZVideoConfig : NSObject
// 录像 的 View 大小

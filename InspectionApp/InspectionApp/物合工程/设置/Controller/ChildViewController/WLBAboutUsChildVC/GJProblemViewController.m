...
@implementation GJProblemViewController
...
- (void)viewDidLoad {
    ...
    UILabel *titlelable = [UILabel lableWithName:@"常见问题"];
...
-(void)getdata
{
    ...
    [network requestNetWithInterface:@"" andM:@"mlgj_api" andF:@"service" andA:@"problem" andBodyOfRequestForKeyArr:@[] andValueArr:@[] andBlock:^(id dictionary) {
        NSLog(@"%@",dictionary);

...
#import "GJConsultationViewCell.h"

@implementation GJConsultationViewCell
...
{
    GJConsultationViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (nil == cell) {
        cell = [[GJConsultationViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
    return cell;
}

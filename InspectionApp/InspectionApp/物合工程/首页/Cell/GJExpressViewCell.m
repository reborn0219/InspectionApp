...
#import "GJExpressViewCell.h"

@implementation GJExpressViewCell
...
-(void)CreatedUI
{
    _TypeLable = [[UILabel alloc]initWithFrame:CGRectMake(10, 5, 50, 20)];
    _TypeLable.textColor = gycolor;
    _TypeLable.textAlignment = NSTextAlignmentLeft;
    _TypeLable.font = [UIFont fontWithName:geshi size:15];
...
{
    GJExpressViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (nil == cell) {
        cell = [[GJExpressViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
    return cell;
}
@end

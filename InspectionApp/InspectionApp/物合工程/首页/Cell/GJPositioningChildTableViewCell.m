//
//  GJPositioningChildTableViewCell.m
//  物联宝管家
//
...
#import "GJPositioningChildTableViewCell.h"

@implementation GJPositioningChildTableViewCell
//
...
//{
//    GJPositioningChildTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
//    if (nil == cell) {
//        cell = [[GJPositioningChildTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
//    }
//    return cell;
//}
@end

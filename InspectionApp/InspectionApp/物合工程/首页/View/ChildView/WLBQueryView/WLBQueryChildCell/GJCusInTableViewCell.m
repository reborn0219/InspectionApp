...
#import "GJCusInTableViewCell.h"

@implementation GJCusInTableViewCell
...
{
    GJCusInTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (nil == cell) {
        cell = [[GJCusInTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
    return cell;
}
@end

...
@protocol ExecutedCellDelegate <NSObject>
...
@interface GJExecutedTableViewCell : UITableViewCell
...
@property(nonatomic,assign)id<ExecutedCellDelegate>executeddelegates;

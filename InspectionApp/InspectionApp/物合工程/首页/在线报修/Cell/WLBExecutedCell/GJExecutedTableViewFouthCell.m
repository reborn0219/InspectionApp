//
//  GJExecutedTableViewFouthCell.m
//  物联宝管家
//
...
@interface GJExecutedTableViewFouthCell()
{
...
@end
@implementation GJExecutedTableViewFouthCell
...
-(void)createLable
{
    ...
    self.FirstImagename.image = [UIImage imageNamed:@"mlgj-2x37"];
...
//-(void)operationButtonDidClicked
//{
...
//{
//    if (sender.tag == 0) {
//        if (self.executedFouthDelegates && [self.executedFouthDelegates respondsToSelector:@selector(ExecutedCellDidClicked:)]) {
//            [self.executedFouthDelegates ExecutedCellDidClicked:self.operateButton.tag];
...
//    {
//        if (self.executedFouthDelegates && [self.executedFouthDelegates respondsToSelector:@selector(WagetransferDidClicked:)]) {
//            [self.executedFouthDelegates WagetransferDidClicked:self.operateButton.tag];
//            [backButtonView removeFromSuperview];
//        }
//        else
//        {
...
+(instancetype)createCellWithTableView:(UITableView *)tableView withIdentifier:(NSString *)identifier{
    GJExecutedTableViewFouthCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (nil == cell) {
        cell = [[GJExecutedTableViewFouthCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
    return cell;
}
@end

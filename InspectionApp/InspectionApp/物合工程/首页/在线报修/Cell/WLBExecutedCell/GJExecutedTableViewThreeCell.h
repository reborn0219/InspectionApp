//
//  GJExecutedTableViewThreeCell.h
//  物联宝管家
//
...
@protocol ExecutedCellThreeDelegate <NSObject>
...
@interface GJExecutedTableViewThreeCell : UITableViewCell
...
@property(nonatomic,assign)id<ExecutedCellThreeDelegate>executedThreeDelegates;
#pragma mark 返回高度的方法
+(CGFloat)height;

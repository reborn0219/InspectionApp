...
@protocol ExecutedCellTwoDelegate <NSObject>
//-(void)ExecutedCellDidClicked:(NSInteger)index;
-(void)WagetransferDidClicked:(NSInteger)index;
@end
@interface GJExecutedTableViewTwoCell : UITableViewCell
...
@property(nonatomic,assign)id<ExecutedCellTwoDelegate>executedTwoDelegates;
#pragma mark 返回高度的方法
+(CGFloat)height;

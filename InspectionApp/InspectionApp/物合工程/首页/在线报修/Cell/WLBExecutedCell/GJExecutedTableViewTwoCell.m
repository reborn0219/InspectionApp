...
@interface GJExecutedTableViewTwoCell()
{
...
@end
@implementation GJExecutedTableViewTwoCell
...
//    if (sender.tag == 0) {
//        if (self.executedTwoDelegates && [self.executedTwoDelegates respondsToSelector:@selector(ExecutedCellDidClicked:)]) {
//            [self.executedTwoDelegates ExecutedCellDidClicked:self.operateButton.tag];
...
//    {
//        if (self.executedTwoDelegates && [self.executedTwoDelegates respondsToSelector:@selector(WagetransferDidClicked:)]) {
//            [self.executedTwoDelegates WagetransferDidClicked:self.operateButton.tag];
//            [backButtonView removeFromSuperview];
//        }
//        else
//        {
...
+(instancetype)createCellWithTableView:(UITableView *)tableView withIdentifier:(NSString *)identifier{
    GJExecutedTableViewTwoCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (cell == nil) {
        cell = [[GJExecutedTableViewTwoCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
    else{

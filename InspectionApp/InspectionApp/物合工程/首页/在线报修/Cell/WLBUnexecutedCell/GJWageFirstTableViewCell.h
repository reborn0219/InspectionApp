...
@interface GJWageFirstTableViewCell : UITableViewCell
...
@property(nonatomic,strong)UILabel *WageTyperLable;
@property(nonatomic,strong)UILabel *bodytextLable;
@property(nonatomic,strong)UIImageView *rightImageView;
@property(nonatomic,strong)UIButton *redLoadbutton;

//
//  GJWageSecondImageTableViewCell.m
//  物联宝管家
//
...
@implementation GJWageSecondImageTableViewCell
...
-(void)setLayoutViews
{
    ...
    self.SecondImagename.image = [UIImage imageNamed:@"mlgj-2x35s"];
    //    内容
    
    self.timeLable = [[UILabel alloc]initWithFrame:CGRectMake(60, 45, 30, 22)];
...
+(instancetype)createCellWithTableView:(UITableView *)tableView withIdentifier:(NSString *)identifier{
    GJWageSecondImageTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (nil == cell) {
        cell = [[GJWageSecondImageTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];

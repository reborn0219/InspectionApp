...
#import "GJFJSlidingController.h"
#import "GJSegmentTapView.h"
@interface GJFJSlidingController ()<SegmentTapViewDelegate,UIPageViewControllerDataSource,UIPageViewControllerDelegate>
...
@implementation GJFJSlidingController
...
-(void)instance{
    ...
    //segmentTapView
    self.segmentTapView = [[GJSegmentTapView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.view.frame), 40)];
    self.segmentTapView.delegate = self;
    [self.view addSubview:self.segmentTapView];
    
    _Redbutton = [[UIButton alloc]initWithFrame:CGRectMake(CGRectGetWidth(self.view.frame)/5 * 2 - 13, 5, 10, 10)];
    _Redbutton.layer.cornerRadius = 5.0;
    [_Redbutton setBackgroundColor:[UIColor redColor]];
    [self.segmentTapView addSubview:_Redbutton];
    
    
    self.pageController = [[UIPageViewController alloc] initWithTransitionStyle:UIPageViewControllerTransitionStyleScroll navigationOrientation:UIPageViewControllerNavigationOrientationHorizontal options:nil];
    self.pageController.view.frame = CGRectMake(0, 40, CGRectGetWidth(self.view.frame), CGRectGetHeight(self.view.frame) - 89);
...
-(void)selectedIndex:(NSInteger)index{
    __weak GJFJSlidingController *weakSelf = self;

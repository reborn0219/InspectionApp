...
{
    MLSecurityYCLDetailVC *fishChildVC = [[MLSecurityYCLDetailVC alloc]init];
    fishChildVC.isAnBao = YES;
    fishChildVC.FishChildDelegates = self;
    fishChildVC.receiveDataDic = [NSDictionary dictionary];
...
{
    MLMarkCompletedVC *execuFishVC = [[MLMarkCompletedVC alloc]init];
    execuFishVC.isAnBao = YES;
...
-(void)addchildVC
{
    ...
    //全部
    MLSecurityWCLVC *WholeVC = [[MLSecurityWCLVC alloc]init];
//    WholeVC.parentController = self;
    WholeVC.isAnBao = YES;
    WholeVC.Wholedelegate = self;
    //待处理
    MLSecurityDCLVC *UnexeVC = [[MLSecurityDCLVC alloc]init];
//    UnexeVC.parentController = self;
    UnexeVC.isAnBao = YES;
    UnexeVC.Unexedelegate = self;
    //处理中
    MLSecurityCLZVC *ExecutVC = [[MLSecurityCLZVC alloc]init];
//    ExecutVC.parentController = self;
    ExecutVC.isAnBao = YES;
    ExecutVC.exeDelegates = self;
    //已处理
    MLSecurityYCLVC *fishVC = [[MLSecurityYCLVC alloc]init];
//    fishVC.parentController = self;
    fishVC.isAnBao = YES;
    fishVC.fishDelegates = self;
    //已完成
    MLSecurityYWCVC *canlVC = [[MLSecurityYWCVC alloc]init];

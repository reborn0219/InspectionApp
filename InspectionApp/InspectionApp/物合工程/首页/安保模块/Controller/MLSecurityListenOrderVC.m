...
@interface MLSecurityListenOrderVC ()<AVSpeechSynthesizerDelegate,UITextFieldDelegate,workNameIDDelegates,UITextViewDelegate,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
{
    NSString *state;
    NSString *DataStr;
...
@implementation MLSecurityListenOrderVC
...
-(void)getVoicewageDataWork
{
    ...
    [network requestNetWithInterface:@"" andM:@"mlgj_api" andF:@"security" andA:@"get_news_order2" andBodyOfRequestForKeyArr:@[@"community_id",@"role"] andValueArr:@[community_id,role] andBlock:^(id dictionary)
...
-(void)WorkorderList333
{
    ...
    if ([unexedataArrayDataOne[@"voice_type"] isEqualToString:@"C"]) {
        ...
        EndPointStr = [NSString stringWithFormat:@"服  务  人 : %@ ",userName];
...
-(void)AdminOrdersButtonDidClicked
{
    if ([unexedataArrayDataOne[@"voice_type"] isEqualToString:@"R"]) {
        ...
        GJLCLNetWork *network = [[GJLCLNetWork alloc]init];
        [network requestNetWithInterface:@"" andM:@"mlgj_api" andF:@"security" andA:@"repair_who" andBodyOfRequestForKeyArr:@[@"property_id",@"community_id",@"start_num",@"per_pager_nums"] andValueArr:@[property_ids,community_ids,@"0",@"100"] andBlock:^(id dictionary)
         {
             state = [NSString stringWithFormat:@"%@",dictionary[@"state"]];
             if ([state isEqualToString:@"5"] || [state isEqualToString:@"4"] || [state isEqualToString:@"2"]) {
                 [GJSVProgressHUD showErrorWithStatus:@"登录失效，请重新登录"];
...
-(void)YESButtonVoiceWageDidClicked:(UIButton *)sender
{
    ...
    else
    {
        ...
        [network submitRequestNetWithInterface:@"" andM:@"mlgj_api" andF:@"security" andA:@"fen_pei" andBodyOfRequestForKeyArr:@[@"repair_id",@"repair_user_id",@"appointed_time",@"remarks",@"type"] andValueArr:@[repairID,theworkID,servingtime,opinionView.text,@"S"] andBlock:^(id dictionary)
         {
             state = [NSString stringWithFormat:@"%@",dictionary[@"state"]];
             if ([state isEqualToString:@"5"] || [state isEqualToString:@"4"] || [state isEqualToString:@"2"]) {
...
#pragma mark - 走抢单接口
        ...
        GJLCLNetWork *network = [[GJLCLNetWork alloc]init];
        [network submitRequestNetWithInterface:@"" andM:@"mlgj_api" andF:@"security" andA:@"grab" andBodyOfRequestForKeyArr:@[@"repair_id",@"property_id"] andValueArr:@[memberID,property_ids] andBlock:^(id dictionary)
         {
        ...
        GJLCLNetWork *network = [[GJLCLNetWork alloc]init];
        [network submitRequestNetWithInterface:@"" andM:@"mlgj_api" andF:@"security" andA:@"receive" andBodyOfRequestForKeyArr:@[@"repair_id"] andValueArr:@[memberID] andBlock:^(id dictionary)
         {
             state = [NSString stringWithFormat:@"%@",dictionary[@"state"]];
             if ([state isEqualToString:@"5"] || [state isEqualToString:@"4"] || [state isEqualToString:@"2"]) {
                 [GJSVProgressHUD showErrorWithStatus:@"登录失效，请重新登录"];
...
{
    GJLCLNetWork *network = [[GJLCLNetWork alloc]init];
    [network submitRequestNetWithInterface:@"" andM:@"mlgj_api" andF:@"security" andA:@"confirm_grab" andBodyOfRequestForKeyArr:@[@"repair_id"] andValueArr:@[str] andBlock:^(id dictionary)
     {

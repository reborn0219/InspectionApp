...
#import "MLSecurityYCLDetailVC.h"
...
@interface MLSecurityYCLDetailVC ()<UITableViewDelegate,UITableViewDataSource,AVAudioPlayerDelegate>
{
    BOOL ISOpenOne;
    BOOL ISOpenTwo;
...
@implementation MLSecurityYCLDetailVC
...
-(CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section
{
    if ([_receiveDataDic[@"is_op"] isEqualToString:@"P"]) {
        if (section == 0)
        {
            if ([[UserDefaults objectForKey:@"isAnbao_autograph"] isEqualToString:@"A"]) {
...
#pragma mark - 这里要添加名字和电话
    ...
    }else if(indexPath.section == i+1)
    {
        ...
        nameArray = @[@"服务人",@"联系电话",@"服务费",@"用户承担费用",@"开始服务时间",@"结束服务时间",@"备注"];

        NSArray *contentArray = [NSArray array];
        
        contentArray = @[_receiveDataDic[@"repaird"][@"repair_master_name"],_receiveDataDic[@"repaird"][@"repair_master_phone"],servicecharge,servicecharge,_receiveDataDic[@"repaird"][@"come_in_time"],_receiveDataDic[@"repaird"][@"come_out_time"],_receiveDataDic[@"repaird"][@"work_remarks"]];
